...
namespace ApartmentBookingApp1.Migrations
{
    ...
    [Migration("20240714105414_EnityModified")]
    partial class EnityModified
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ApartmentBookingApp1.Data.Entities.Client", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ApartmentBookingApp1.Data.Entities.LocalGovernment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ApartmentBookingApp1.Data.Entities.State", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ApartmentBookingApp1.Data.Entities.User", b =>
                {
            ...
            modelBuilder.Entity("ApartmentBookingApp1.Data.Entities.Booking", b =>
                {
                    b.HasOne("ApartmentBookingApp1.Data.Entities.Apartment", "Apartment")
                        .WithMany()
            ...
            modelBuilder.Entity("ApartmentBookingApp1.Data.Entities.Client", b =>
                {
                    b.HasOne("ApartmentBookingApp1.Data.Entities.User", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("ApartmentBookingApp1.Data.Entities.LocalGovernment", b =>
                {
                    b.HasOne("ApartmentBookingApp1.Data.Entities.State", "State")
